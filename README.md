...
## CIRCUIT DIAGRAM 
  <img width="1155" height="813" alt="image" src="https://github.com/user-attachments/assets/aeda73f2-9370-4e3c-8f94-08568fb6b089" />
...
// LCD handle and pin configuration
...
void key(void)
{
    // Recreate LCD handle (optional, but included in your code)
    Lcd_HandleTypeDef lcd;
    lcd = Lcd_create(ports, pins, GPIOB, GPIO_PIN_0, GPIOB, GPIO_PIN_1, LCD_4_BIT_MODE);
...
## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1168" height="802" alt="image" src="https://github.com/user-attachments/assets/34eb2736-b616-4b58-b713-e1eebaddbeea" />
